...
class _PruebaTransbankUIState extends State<PruebaTransbankUI> {
  ...
  Map<String, dynamic> datosEntrada = {
    "cantidad": 1,
    "fechas": [],
    "evento": "",
    "cantidadPorFecha": []
  ...
  Widget entradaFormulario(Map<String, dynamic> datosEntrada) {
        ...
        onSelected: (bool selected) {
          setState(() {
            if (selected) {
              ...
              cantidadPorFecha.add(0);
              print("se ha agregado una fecha");
            } else {
              final index = fechasSeleccionadas.indexOf(fecha);
              fechasSeleccionadas.remove(fecha);
              cantidadPorFecha.removeAt(index);
              print("Se ha eliminado una fecha");
            }
            datosEntrada["fechas"] = fechasSeleccionadas;
            datosEntrada["cantidadPorFecha"] = cantidadPorFecha;
            datosEntrada["nombre"] = _eventoSeleccionado!["nombre"];
            print(datosEntrada);
          });
        },
      );
                                ...
                                child: FilterChip(
                                  ...
                                  onSelected: (bool selected) {
                                    setState(() {
                                      ...
                                      datosEntrada["fechas"] =
                                          fechasSeleccionadas;
                                      datosEntrada["cantidad"] = _formKey
                                          .currentState!
                                          .fields['cantidad']!
                                          .value;
                                      datosEntrada["nombre"] =
                              ...
                              return Column(
                                ...
                                children: [
                                  ...
                                  FormBuilderDropdown(
                                    ...
                                    onChanged: (value) {
                                      setState(() {
                                        cantidadPorFecha[index] =
                                            int.parse(value.toString());
                                        datosEntrada["cantidadPorFecha"] =
                                            cantidadPorFecha;
                                      });
                                    },
                                  ),
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.saveAndValidate()) {
                      ...
                      for (var fecha in fechasSeleccionadas) {
                            ...
                            onPressed: () {
                              if (_formKey.currentState!.saveAndValidate()) {
                                ...
                                for (var fecha in fechasSeleccionadas) {
                                  ...
                                  listaCompras.add({nombreCompra: nuevaCompra});
                                  cantidadCompras++;
                                  contadorCompras++;
                                }
                                datosEntrada = {
  ...
  Widget vistaTransbankStudio() {
    return Container(
        ...
        child: mostrarGridImagenes
            ? gridImagenes()
            : mostrarFormulario
                ? entradaFormulario(datosEntrada)
                : mostrarDatosUsuario
                    ? datosUsuario()
                    : Container());
  }
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              style: ButtonStyle(
                backgroundColor: MaterialStateProperty.all<Color>(colorNaranja),
              ),
